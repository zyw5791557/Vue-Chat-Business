    ...
    methods: {
        ...
        normalSmartProcess (param, type) { 
            ...
            if(FTA !== null && f !== null) {
                ...
                return `
                    <div class="image">
                        <img data-original="${process.env.STATIC_API}/api/imgload?url=${param}" src="${process.env.STATIC_API}/api/imgload?url=${param}" onerror="this.src='/static/images/imgError.jpg'" style="max-height: 200px;">
                    </div>
                `;
            }
            // 单独剥离 gif 图
            if(FTA !== null && gf !== null) {
                return `
                    <div class="image">
                        <img class="gif-image" data-original="${process.env.STATIC_API}/api/imgload?url=${param}" src="${process.env.STATIC_API}/api/imgload?url=${param}" onerror="this.src='/static/images/imgError.jpg'" style="max-height: 200px;">
                    </div>
                `;
            }
            // 渲染链接
